...
/* This is the same as dance, but add a system call
 *  to call a python neopixel program
 *  Tutorial for installing neopixel on the PI Zero W
...
void setup() {
  ...
  //Modified strandtest.py and copied it to the home directory.
  system("sudo python /home/pi/strandtest.py -c &");
